...
export declare enum RegulatorType {
    /** PID */
    Pid = "pid",
    /** PWM */
    Pwm = "pwm"
...
export declare enum ThermostatTimeFormat {
    /** H12 */
    H12 = "h12",
    /** H24 */
    H24 = "h24"
...
export declare enum ValidLocationMode {
    /** FROST */
    Frost = "frost",
    /** GEO */
    Geo = "geo",
...
export type AccessDayResolvers<ContextType = any, ParentType extends ResolversParentTypes['AccessDay'] = ResolversParentTypes['AccessDay']> = {
...
export type AggregateMobileResolvers<ContextType = any, ParentType extends ResolversParentTypes['AggregateMobile'] = ResolversParentTypes['AggregateMobile']> = {
...
export type AppFeedbackEntityResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppFeedbackEntity'] = ResolversParentTypes['AppFeedbackEntity']> = {
...
export type AutoPropertiesResolvers<ContextType = any, ParentType extends ResolversParentTypes['AutoProperties'] = ResolversParentTypes['AutoProperties']> = {
...
export type DashboardStatsResolvers<ContextType = any, ParentType extends ResolversParentTypes['DashboardStats'] = ResolversParentTypes['DashboardStats']> = {
    accessDay?: Resolver<Maybe<Array<Maybe<ResolversTypes['AccessDay']>>>, ParentType, ContextType, Partial<DashboardStatsAccessDayArgs>>;
    appFw?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<DashboardStatsAppFwArgs>>;
    deviceStats?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<DashboardStatsDeviceStatsArgs>>;
    elbStats?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType>;
    general?: Resolver<Maybe<ResolversTypes['GeneralStatistic']>, ParentType, ContextType, Partial<DashboardStatsGeneralArgs>>;
    systemTypes?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<DashboardStatsSystemTypesArgs>>;
    userStats?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<DashboardStatsUserStatsArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type DeviceAccessStatisticResolvers<ContextType = any, ParentType extends ResolversParentTypes['DeviceAccessStatistic'] = ResolversParentTypes['DeviceAccessStatistic']> = {
...
export type DeviceShortLogResolvers<ContextType = any, ParentType extends ResolversParentTypes['DeviceShortLog'] = ResolversParentTypes['DeviceShortLog']> = {
    created?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type EmailRecordEntityResolvers<ContextType = any, ParentType extends ResolversParentTypes['EmailRecordEntity'] = ResolversParentTypes['EmailRecordEntity']> = {
    brand?: Resolver<Maybe<ResolversTypes['Brand']>, ParentType, ContextType>;
...
export type ExpireResolvers<ContextType = any, ParentType extends ResolversParentTypes['Expire'] = ResolversParentTypes['Expire']> = {
    expiresAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    isExpired?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type FenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Fence'] = ResolversParentTypes['Fence']> = {
    offset?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    time?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type GeneralStatisticResolvers<ContextType = any, ParentType extends ResolversParentTypes['GeneralStatistic'] = ResolversParentTypes['GeneralStatistic']> = {
...
export type HeatingMutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['HeatingMutation'] = ResolversParentTypes['HeatingMutation']> = {
    acceptGrant?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, RequireFields<HeatingMutationAcceptGrantArgs, 'code'>>;
    addDevice?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<HeatingMutationAddDeviceArgs, 'floorType' | 'lid' | 'name' | 'powerSource' | 'roomType' | 'serial' | 'systemPower' | 'systemType'>>;
    addEndpoints?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationAddEndpointsArgs, 'eps'>>;
    addFeedback?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationAddFeedbackArgs>>;
    addLocation?: Resolver<Maybe<ResolversTypes['Location']>, ParentType, ContextType, RequireFields<HeatingMutationAddLocationArgs, 'lat' | 'long' | 'name'>>;
    addNote?: Resolver<Maybe<ResolversTypes['NoteEntity']>, ParentType, ContextType, Partial<HeatingMutationAddNoteArgs>>;
    addSwitch?: Resolver<Maybe<ResolversTypes['SwitchSnapshot']>, ParentType, ContextType, Partial<HeatingMutationAddSwitchArgs>>;
    addSwitchPlan?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<HeatingMutationAddSwitchPlanArgs>>;
    addUser?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, RequireFields<HeatingMutationAddUserArgs, 'email' | 'password'>>;
    adminDeleteLocation?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationAdminDeleteLocationArgs, 'lid' | 'uid'>>;
    adminDeviceDelete?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationAdminDeviceDeleteArgs, 'lid'>>;
    adminFields?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, Partial<HeatingMutationAdminFieldsArgs>>;
    adminFirmware?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationAdminFirmwareArgs>>;
    cancelAllOverrides?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationCancelAllOverridesArgs>>;
    cancelHoliday?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationCancelHolidayArgs, 'lid'>>;
    cancelOverride?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, Partial<HeatingMutationCancelOverrideArgs>>;
    cancelSwitch?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<HeatingMutationCancelSwitchArgs>>;
    changeEmail?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationChangeEmailArgs>>;
    changePassword?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<HeatingMutationChangePasswordArgs>>;
    createShadow?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationCreateShadowArgs, 'serial' | 'token' | 'type'>>;
    deleteDevice?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeleteDeviceArgs, 'lid' | 'rid'>>;
    deleteLocation?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeleteLocationArgs, 'lid'>>;
    deltaTemperature?: Resolver<Maybe<ResolversTypes['Thermostat4iE']>, ParentType, ContextType, Partial<HeatingMutationDeltaTemperatureArgs>>;
    deviceAdvanced?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceAdvancedArgs, 'lid'>>;
    deviceFixed?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceFixedArgs, 'lid'>>;
    deviceFrost?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceFrostArgs, 'lid'>>;
    deviceHoliday?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceHolidayArgs, 'lid' | 'temperature'>>;
    deviceOff?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceOffArgs, 'lid'>>;
    deviceOverride?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceOverrideArgs, 'lid' | 'minutes' | 'temperature'>>;
    deviceProgram?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceProgramArgs, 'lid'>>;
    deviceReLoad?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType, Partial<HeatingMutationDeviceReLoadArgs>>;
    deviceSchedule?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<HeatingMutationDeviceScheduleArgs, 'lid' | 'schedule'>>;
    disableBeta?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType, Partial<HeatingMutationDisableBetaArgs>>;
    ...
    fwShadow?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<HeatingMutationFwShadowArgs, 'serial' | 'token' | 'type'>>;
    gen2Cvm?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, RequireFields<HeatingMutationGen2CvmArgs, 'serial' | 'token'>>;
    initShadow?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationInitShadowArgs, 'serial' | 'token' | 'type'>>;
    locationAdvanced?: Resolver<Maybe<ResolversTypes['Location']>, ParentType, ContextType, RequireFields<HeatingMutationLocationAdvancedArgs, 'lid'>>;
    portalLogin?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    removeGuestShare?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationRemoveGuestShareArgs>>;
    removeMe?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationRemoveMeArgs, 'password'>>;
    removeMobile?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationRemoveMobileArgs, 'lid'>>;
    removeMyShare?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationRemoveMyShareArgs>>;
    resetMobileName?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationResetMobileNameArgs>>;
    sendSmsPin?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    setAutoPreferences?: Resolver<Maybe<ResolversTypes['AutoProperties']>, ParentType, ContextType, Partial<HeatingMutationSetAutoPreferencesArgs>>;
    setComfortTemp?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<HeatingMutationSetComfortTempArgs, 'comfTemp'>>;
    setGeo?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationSetGeoArgs, 'geo' | 'lid'>>;
    setMessageCloudToken?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType, Partial<HeatingMutationSetMessageCloudTokenArgs>>;
    setRoomMode?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<HeatingMutationSetRoomModeArgs, 'roomMode'>>;
    setTemperature?: Resolver<Maybe<ResolversTypes['Thermostat4iE']>, ParentType, ContextType, Partial<HeatingMutationSetTemperatureArgs>>;
    setZones?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationSetZonesArgs, 'locZones'>>;
    shareLocation?: Resolver<Maybe<Array<Maybe<ResolversTypes['InviteLocationConfirmationEntity']>>>, ParentType, ContextType, Partial<HeatingMutationShareLocationArgs>>;
    ...
    updateProfile?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<HeatingMutationUpdateProfileArgs>>;
    updateSleep?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, Partial<HeatingMutationUpdateSleepArgs>>;
    updateSwitchReport?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<HeatingMutationUpdateSwitchReportArgs>>;
    upgradeLatestFw?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationUpgradeLatestFwArgs, 'lid'>>;
    upgradeShadow?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<HeatingMutationUpgradeShadowArgs, 'serial' | 'token' | 'type'>>;
    validatePin?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, Partial<HeatingMutationValidatePinArgs>>;
};
export type HeatingQueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['HeatingQuery'] = ResolversParentTypes['HeatingQuery']> = {
...
export type InviteLocationConfirmationEntityResolvers<ContextType = any, ParentType extends ResolversParentTypes['InviteLocationConfirmationEntity'] = ResolversParentTypes['InviteLocationConfirmationEntity']> = {
    brand?: Resolver<Maybe<ResolversTypes['Brand']>, ParentType, ContextType>;
...
export type LocZoneResolvers<ContextType = any, ParentType extends ResolversParentTypes['LocZone'] = ResolversParentTypes['LocZone']> = {
    isHoming?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
    offset?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    time?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    zone?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type LocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Location'] = ResolversParentTypes['Location']> = {
    ...
    created?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    devices?: Resolver<Maybe<Array<Maybe<ResolversTypes['Thermostat4iE']>>>, ParentType, ContextType, Partial<LocationDevicesArgs>>;
...
export type LocationSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LocationSettings'] = ResolversParentTypes['LocationSettings']> = {
...
export type LocationShareObjectResolvers<ContextType = any, ParentType extends ResolversParentTypes['LocationShareObject'] = ResolversParentTypes['LocationShareObject']> = {
...
export type MainVersionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MainVersion'] = ResolversParentTypes['MainVersion']> = {
...
export type MobileDeviceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MobileDevice'] = ResolversParentTypes['MobileDevice']> = {
    appId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type NoteEntityResolvers<ContextType = any, ParentType extends ResolversParentTypes['NoteEntity'] = ResolversParentTypes['NoteEntity']> = {
    createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ParametersWithChangeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ParametersWithChange'] = ResolversParentTypes['ParametersWithChange']> = {
...
export type RestrictedUserResolvers<ContextType = any, ParentType extends ResolversParentTypes['RestrictedUser'] = ResolversParentTypes['RestrictedUser']> = {
    brand?: Resolver<Maybe<ResolversTypes['Brand']>, ParentType, ContextType>;
    created?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type RoomSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoomSettings'] = ResolversParentTypes['RoomSettings']> = {
...
export type SupportResolvers<ContextType = any, ParentType extends ResolversParentTypes['Support'] = ResolversParentTypes['Support']> = {
    ...
    deviceStatistics?: Resolver<Maybe<Array<Maybe<ResolversTypes['DeviceAccessStatistic']>>>, ParentType, ContextType, RequireFields<SupportDeviceStatisticsArgs, 'sn'>>;
    email?: Resolver<Maybe<ResolversTypes['EmailRecordEntity']>, ParentType, ContextType, RequireFields<SupportEmailArgs, 'id'>>;
    emails?: Resolver<Maybe<Array<Maybe<ResolversTypes['EmailRecordEntity']>>>, ParentType, ContextType, Partial<SupportEmailsArgs>>;
    feedback?: Resolver<Maybe<Array<Maybe<ResolversTypes['AppFeedbackEntity']>>>, ParentType, ContextType, Partial<SupportFeedbackArgs>>;
    getAudienceToken?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<SupportGetAudienceTokenArgs>>;
    homeserveOrders?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, Partial<SupportHomeserveOrdersArgs>>;
    latestRecords?: Resolver<Maybe<Array<Maybe<ResolversTypes['DeviceShortLog']>>>, ParentType, ContextType, RequireFields<SupportLatestRecordsArgs, 'sn'>>;
    notes?: Resolver<Maybe<Array<Maybe<ResolversTypes['NoteEntity']>>>, ParentType, ContextType, RequireFields<SupportNotesArgs, 'userId'>>;
    room?: Resolver<Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<SupportRoomArgs, 'id'>>;
    rooms?: Resolver<Maybe<Array<Maybe<ResolversTypes['Room']>>>, ParentType, ContextType, RequireFields<SupportRoomsArgs, 'sn'>>;
    timeseries?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, RequireFields<SupportTimeseriesArgs, 'sn'>>;
    todayChanges?: Resolver<Maybe<ResolversTypes['Json']>, ParentType, ContextType, RequireFields<SupportTodayChangesArgs, 'sn'>>;
    user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, RequireFields<SupportUserArgs, 'id'>>;
    users?: Resolver<Maybe<Array<Maybe<ResolversTypes['User']>>>, ParentType, ContextType, RequireFields<SupportUsersArgs, 'email'>>;
    voucherBatch?: Resolver<Maybe<Array<Maybe<ResolversTypes['VoucherBatch']>>>, ParentType, ContextType, Partial<SupportVoucherBatchArgs>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type SwitchReportResolvers<ContextType = any, ParentType extends ResolversParentTypes['SwitchReport'] = ResolversParentTypes['SwitchReport']> = {
...
export type SwitchSnapshotResolvers<ContextType = any, ParentType extends ResolversParentTypes['SwitchSnapshot'] = ResolversParentTypes['SwitchSnapshot']> = {
    createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    id?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type TariffResolvers<ContextType = any, ParentType extends ResolversParentTypes['Tariff'] = ResolversParentTypes['Tariff']> = {
    cost?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type Thermostat4iEResolvers<ContextType = any, ParentType extends ResolversParentTypes['Thermostat4iE'] = ResolversParentTypes['Thermostat4iE']> = {
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
    ...
    guestShares?: Resolver<Maybe<Array<Maybe<ResolversTypes['InviteLocationConfirmationEntity']>>>, ParentType, ContextType, Partial<UserGuestSharesArgs>>;
    id?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    ...
    myShares?: Resolver<Maybe<Array<Maybe<ResolversTypes['LocationShareObject']>>>, ParentType, ContextType, Partial<UserMySharesArgs>>;
    ...
    switchReports?: Resolver<Maybe<ResolversTypes['SwitchReport']>, ParentType, ContextType, Partial<UserSwitchReportsArgs>>;
    ...
    verifyPassword?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<UserVerifyPasswordArgs, 'pass'>>;
    visibility?: Resolver<Maybe<ResolversTypes['UserVisibility']>, ParentType, ContextType>;
    visibleDevice?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<UserVisibleDeviceArgs, 'serial'>>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type UserTokenInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserTokenInfo'] = ResolversParentTypes['UserTokenInfo']> = {
...
export type UserVisibilityResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserVisibility'] = ResolversParentTypes['UserVisibility']> = {
    isEnabled?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
...
export type VoucherBatchResolvers<ContextType = any, ParentType extends ResolversParentTypes['VoucherBatch'] = ResolversParentTypes['VoucherBatch']> = {
    createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    expiresAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    id?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
